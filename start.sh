...
then
    ...
    gunicorn --bind 0.0.0.0:5000 --chdir ./www app:application --timeout 120 --workers=2 --access-logfile /var/log/gunicorn-access.log --error-logfile /var/log/gunicorn-error.log --log-level info
elif [ $env = 'testing' ]
then
